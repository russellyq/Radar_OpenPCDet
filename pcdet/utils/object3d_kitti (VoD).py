...
# def VoD_label_to_kitti(label):
#     to_kitti = {'rider': 'Cyclist', 'bicycle': 'Cyclist'}
#     if label not in to_kitti.keys():
#         return label
#     return to_kitti[label]
...
class Object3d(object):
    def __init__(self, line):
        ...
        # self.cls_type = VoD_label_to_kitti(label[0])
        ...
        self.score = float(label[15]) if label.__len__() == 16 else 0.0
