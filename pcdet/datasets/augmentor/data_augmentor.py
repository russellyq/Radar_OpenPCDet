...
#     # def random_image_and_points_flip(self, data_dict=None, config=None):
#     #     if data_dict is None:
#     #         return partial(self.random_image_and_points_flip, config=config)
#     #     images = data_dict["images"]
...
#     #     for cur_axis in config['ALONG_AXIS_LIST']:
#     #         assert cur_axis in ['horizontal']
#     #         points, images, gt_boxes = getattr(augmentor_utils, 'random_image_and_points_flip_%s' % cur_axis)(
#     #             points, images, gt_boxes, calib,
#     #         )
