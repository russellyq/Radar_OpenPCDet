...
def get_official_eval_result(gt_annos, dt_annos, current_classes, PR_detail_dict=None):
    ...
    result+=print_str("Results: \n"
            ...
            f"mAOS: {(ret_dict_VoD_Entire['Car_aos_all'] + ret_dict_VoD_Entire['Pedestrian_aos_all'] + ret_dict_VoD_Entire['Cyclist_aos_all']) / 3} \n"
    ...
    result+=print_str("Results: \n"
            ...
            f"mAOS: {(ret_dict_VoD_Driving['Car_aos_all'] + ret_dict_VoD_Driving['Pedestrian_aos_all'] + ret_dict_VoD_Driving['Cyclist_aos_all']) / 3} \n"
            )
