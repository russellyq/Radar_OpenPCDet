...
class Detector3DTemplate(nn.Module):
    ...
    def build_networks(self):
        ...
        print('point_feature_encoder.num_point_features: ', self.dataset.point_feature_encoder.num_point_features)
        print('point_cloud_range: ', self.dataset.point_cloud_range)
        print('grid_size: ', self.dataset.grid_size)
        print('voxel_size: ', self.dataset.voxel_size)
