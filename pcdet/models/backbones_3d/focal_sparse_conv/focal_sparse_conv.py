...
class FocalSparseConv(spconv.SparseModule):
    ...
    def _gen_sparse_features(self, x, imps_3d, batch_dict, voxels_3d):
        ...
        x_fore = spconv.SparseConvTensor(voxel_features_fore, voxel_indices_fore.type(torch.cuda.IntTensor), x.spatial_shape, x.batch_size)
        x_back = spconv.SparseConvTensor(voxel_features_back, voxel_indices_back.type(torch.cuda.IntTensor), x.spatial_shape, x.batch_size)
