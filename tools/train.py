...
# CUDA_VISIBLE_DEVICES=2,3 python -m torch.distributed.launch --nproc_per_node=2 train.py --launcher pytorch --cfg_file cfgs/astyx_models/pointpillar.yaml --batch_size 10 --ckpt ../output/
...
def main():
    ...
    cfg.ROOT_DIR = Path('/home/newdisk/yanqiao/')
